...
class LotController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('lots.index', compact('lots', 'appelsOffres'));
        } catch (Exception $e) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('lots.show', $lot->id_lot)
                ->with('success', 'Lot créé avec succès');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function show(Request $request, $id)
    {
        try {
            ...
            // return view('appels-offres.lot-show', compact('lot'));
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('lots.show', $nouvelleVersion->id_lot)
