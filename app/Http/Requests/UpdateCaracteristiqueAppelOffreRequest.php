...
class UpdateCaracteristiqueAppelOffreRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'motif_modification_caracteristique_appel_offre' => 'required|string|max:1000',
        ];
    }
    ...
    public function attributes(): array
    {
        return [
            ...
            'motif_modification_caracteristique_appel_offre' => 'motif de modification',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'motif_modification_caracteristique_appel_offre.max' => 'Le motif ne peut pas dépasser 1000 caractères.',
        ];
    }
}
