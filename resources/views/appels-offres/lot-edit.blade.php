        ...
        <div class="mb-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg shadow-sm">
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-blue-700 text-sm"> La modification de ce lot créera une nouvelle version. L'ancienne version sera conservée dans l'historique. Le motif de modification est <strong>obligatoire</strong>.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date_fin_prevue" required id="date_fin_prevue"
