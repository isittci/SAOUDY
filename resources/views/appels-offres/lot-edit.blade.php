...
@section('content')
    ...
    <main class="flex-1 overflow-y-auto bg-gradient-to-br from-gray-50 to-gray-100 p-3 sm:p-4 lg:p-6">
        ...
        <!-- Formulaire -->
        <form method="POST" action="{{ route('lots-appels-offres.update', [$lot->appel_offre_id, $lot->id_lot]) }}" class="max-w-5xl mx-auto">
            @csrf
            @method('PUT')

            {{-- route('lots.update', $lot->id_lot) --}}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="date"
                                    ...
                                    {{-- value="{{ old('date_fin_prevue', $lot->date_fin_prevue ?? '') }}" --}}
