                                ...
                                <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200 overflow-hidden">
                                    ...
                                    <div class="p-5 space-y-5">
                                        <div class="grid grid-cols-2 gap-5">
                                            <div>
                                                <label class="block text-sm font-semibold text-gray-700 mb-2">Numéro proforma <span class="text-red-500">*</span></label>
                                                <input type="text" name="new_numero_proforma" id="new_numero_proforma" value="{{ old('new_numero_proforma') }}" maxlength="20" placeholder="PRO-2024-001" class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-400">
                                            </div>
                                            <div>
                                        ...
                                        <div class="bg-white/60 p-4 rounded-lg border border-purple-100">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        <input type="number" name="new_tva_pourcentage" id="new_tva_pourcentage" value="{{ old('new_tva_pourcentage', 18) }}" min="0" max="100" step="0.01" class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-400 pr-10">
                                                        <span class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400">%</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <label class="block text-xs text-gray-500 mb-1">Montant TVA (FCFA)</label>
                                                    <input type="number" name="new_taxe_montant" id="new_taxe_montant" value="{{ old('new_taxe_montant', 0) }}" readonly class="w-full px-4 py-3 border rounded-lg bg-orange-50 text-orange-700 font-semibold cursor-not-allowed">
                                                    <p class="text-xs text-gray-400 mt-1 italic">Calculé auto</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Remise -->
                                        <div class="bg-white/60 p-4 rounded-lg border border-purple-100">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        <input type="number" name="new_remise_pourcentage" id="new_remise_pourcentage" value="{{ old('new_remise_pourcentage', 0) }}" min="0" max="100" step="0.01" class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-400 pr-10">
                                                        <span class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400">%</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <label class="block text-xs text-gray-500 mb-1">Montant remise (FCFA)</label>
                                                    <input type="number" name="new_remise_montant" id="new_remise_montant" value="{{ old('new_remise_montant', 0) }}" readonly class="w-full px-4 py-3 border rounded-lg bg-green-50 text-green-700 font-semibold cursor-not-allowed">
                                                    <p class="text-xs text-gray-400 mt-1 italic">Calculé auto</p>
                                                </div>
                                            </div>
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleMode(){
        ...
        ['new_numero_proforma','new_date_proforma','new_montant_retenu'].forEach(id=>{const el=document.getElementById(id);if(el)el.required=!isSelect;});
