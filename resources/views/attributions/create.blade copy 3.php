            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        <div class="px-6 py-4 bg-gradient-to-r from-orange-50 to-white border-b"><h2 class="text-lg font-bold text-gray-800"><i class="fas fa-link text-orange-500 mr-2"></i>Informations principales</h2></div>
                        <div class="p-6 space-y-5">
                            <div>
                                <label for="lot_id" class="block text-sm font-semibold text-gray-700 mb-2">Lot à attribuer <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label for="prestataire_id" class="block text-sm font-semibold text-gray-700 mb-2">Prestataire <span class="text-red-500">*</span></label>
                    ...
                    <!-- Proforma -->
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        <div class="px-6 py-4 bg-gradient-to-r from-purple-50 to-white border-b"><h2 class="text-lg font-bold text-gray-800"><i class="fas fa-file-invoice text-purple-500 mr-2"></i>Proforma</h2></div>
                        <div class="p-6 space-y-5">
                            <!-- Choix mode -->
                            <div class="flex items-center space-x-6">
                                <label for="mode_select" class="flex items-center cursor-pointer group">
                                ...
                                <label for="mode_create" class="flex items-center cursor-pointer group">
                            ...
                            <div id="proforma_select_section" class="{{ old('proforma_mode') === 'create' ? 'hidden' : '' }}">
                                <label for="proforma_id" class="block text-sm font-semibold text-gray-700 mb-2">Proforma existante <span class="text-red-500">*</span></label>
                                ...
                                <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200 overflow-hidden">
                                    ...
                                    <div class="p-5 space-y-5">
                                        <div class="grid grid-cols-2 gap-5">
                                            <div>
                                                <label for="new_numero_proforma" class="block text-sm font-semibold text-gray-700 mb-2">Numéro proforma <span class="text-gray-400 text-xs font-normal">(optionnel)</span></label>
                                            ...
                                            <div>
                                                <label for="new_date_proforma" class="block text-sm font-semibold text-gray-700 mb-2">Date proforma <span class="text-red-500">*</span></label>
                                        ...
                                        <div>
                                            <label for="new_date_redemarrage" class="block text-sm font-semibold text-gray-700 mb-2">Date de redémarrage <span class="text-red-500">*</span></label>
                                        ...
                                        <div>
                                            <label for="new_montant_retenu" class="block text-sm font-semibold text-gray-700 mb-2">Montant retenu HT (FCFA) <span class="text-red-500">*</span></label>
                                        ...
                                        <div class="grid grid-cols-2 gap-5">
                                            <div class="bg-white/60 p-4 rounded-lg border border-purple-100">
                                                ...
                                                <div>
                                                    <label for="new_tva_pourcentage" class="block text-xs text-gray-500 mb-1">Taux TVA (%)</label>
                                                    <div class="relative">
                                                ...
                                                <div class="mt-3">
                                                    <label for="new_taxe_montant" class="block text-xs text-gray-500 mb-1">Montant TVA (FCFA)</label>
                                            ...
                                            <div class="bg-white/60 p-4 rounded-lg border border-purple-100">
                                                ...
                                                <div>
                                                    <label for="new_remise_pourcentage" class="block text-xs text-gray-500 mb-1">Taux remise (%)</label>
                                                    <div class="relative">
                                                ...
                                                <div class="mt-3">
                                                    <label for="new_remise_montant" class="block text-xs text-gray-500 mb-1">Montant remise (FCFA)</label>
                                        ...
                                        <div class="grid grid-cols-2 gap-5">
                                            <div>
                                                <label for="new_penalites" class="block text-sm font-semibold text-gray-700 mb-2">Pénalités (FCFA)</label>
                                            ...
                                            <div>
                                                <label for="new_modalite" class="block text-sm font-semibold text-gray-700 mb-2">Modalités paiement</label>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-3 gap-5">
                                <div>
                                    <label for="date_attribution" class="block text-sm font-semibold text-gray-700 mb-2">Date attribution <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="date_debut_prevue" class="block text-sm font-semibold text-gray-700 mb-2">Date début <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="date_fin_prevue" class="block text-sm font-semibold text-gray-700 mb-2">Date fin <span class="text-red-500">*</span></label>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-5">
                            <div>
                                ...
                                <textarea name="observations" rows="3" id="observations" class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-gray-400" placeholder="Notes...">{{ old('observations') }}</textarea>
                            </div>
                            <div>
                                <label for="conditions_particulieres" class="block text-sm font-semibold text-gray-700 mb-2">Conditions particulières</label>
                                <textarea name="conditions_particulieres" id="conditions_particulieres" rows="3" class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-gray-400" placeholder="Conditions spécifiques...">{{ old('conditions_particulieres') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                <label for="taux_penalites" class="block text-sm font-semibold text-gray-700 mb-2">Taux pénalités (%)</label>
...
<style>
    .ts-wrapper.single .ts-control{padding:.75rem 1rem;border-radius:.5rem;border-color:#d1d5db;min-height:50px}
    .ts-wrapper.single .ts-control:hover{border-color:#f97316}
    .ts-wrapper.focus .ts-control{border-color:#f97316;box-shadow:0 0 0 2px rgba(249,115,22,.2)}
    .ts-dropdown{border-radius:.5rem;box-shadow:0 10px 25px -5px rgba(0,0,0,.1)}
    .ts-dropdown .option{padding:.75rem 1rem}
    .ts-dropdown .option.active{background:#fff7ed;color:#c2410c}
    .ts-dropdown .option:hover{background:#ffedd5}
</style>
@endpush
