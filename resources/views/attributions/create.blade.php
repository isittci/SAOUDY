    ...
    <div class="bg-gradient-to-r from-gray-50 to-white border-b border-gray-200 shadow-sm">
        <div class="px-3 sm:px-4 lg:px-6 py-4">
            <div class="flex items-center space-x-4">
                <a href="{{ route('attributions.index') }}" class="p-2 hover:bg-gray-100 rounded-lg"><i
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg">
                        <div class="px-6 py-4 bg-gradient-to-r from-orange-50 to-white border-b rounded-t-2xl">
                            <h2 class="text-lg font-bold text-gray-800"><i
                                    class="fas fa-link text-orange-500 mr-2"></i>Informations principales</h2>
                        </div>
                        <div class="p-6 space-y-5">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Lot à attribuer <span
                                ...
                                <select name="prestataire_id" id="prestataire_id" required
                                    ...
                                    @foreach ($prestataires as $prestataire)
                                        <option value="{{ $prestataire->id_prestataire }}"
                                            ...
                                            data-ville="{{ $prestataire->ville_prestataire }}"
                                            data-telephone="{{ $prestataire->telephone_prestataire }}">
                                            {{ $prestataire->raison_sociale_prestataire }}@if ($prestataire->ville_prestataire)
                    ...
                    <div class="bg-white rounded-2xl shadow-lg">
                        <div class="px-6 py-4 bg-gradient-to-r from-purple-50 to-white border-b rounded-t-2xl">
                            <h2 class="text-lg font-bold text-gray-800"><i
                                    class="fas fa-file-invoice text-purple-500 mr-2"></i>Proforma</h2>
                        </div>
                        <div class="p-6 space-y-5">
                            <!-- Choix mode -->
                            <div class="flex items-center space-x-6">
                                ...
                                <label class="flex items-center cursor-pointer group">
                                    <input type="radio" name="proforma_mode" value="create" id="mode_create"
                                        class="w-5 h-5 text-purple-600" checked>
                                    <span class="ml-3 text-sm font-medium text-gray-700 group-hover:text-purple-600"><i
                                            class="fas fa-plus-circle mr-1"></i>Créer nouvelle</span>
                                </label>
                            </div>
                            ...
                            <!-- Création nouvelle -->
                            <div id="proforma_create_section">
                                <div
                                    ...
                                    <div class="px-5 py-4 bg-purple-100/50 border-b border-purple-200">
                                        <h3 class="font-semibold text-purple-800"><i
                                                class="fas fa-file-medical mr-2"></i>Nouvelle Proforma</h3>
                                    ...
                                    <div class="p-5 space-y-5">
                                        <div class="grid grid-cols-2 gap-5">
                                            <div>
                                                <label class="block text-sm font-semibold text-gray-700 mb-2">Numéro
                                                    proforma  <span class="text-red-500">*</span></label>
                                                ...
                                                <p class="text-xs text-gray-500 mt-1"><i
                                                        class="fas fa-magic mr-1"></i>Format auto: PROF-2024-0001</p>
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-2">Date de
                                                redémarrage <span class="text-red-500">*</span></label>
                                            <input type="date" name="new_date_redemarrage" id="new_date_redemarrage"
                                                value="{{ old('new_date_redemarrage') }}"
                                                class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-400">
                                            <p class="text-xs text-gray-500 mt-1"><i
                                                    class="fas fa-play-circle mr-1"></i>Date prévue de démarrage des travaux
                                            </p>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-2">Montant retenu HT
                                                (FCFA) <span class="text-red-500">*</span></label>
                                            <input type="number" name="new_montant_retenu" id="new_montant_retenu"
                                                value="{{ old('new_montant_retenu', 0) }}" min="0"
                                                class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-400">
                                        </div>
                                        <!-- TVA et Remise -->
                                        <div class="grid grid-cols-2 gap-5">
                                            <div class="bg-white/60 p-4 rounded-lg border border-purple-100">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        <input type="number" id="new_tva_pourcentage" value="18"
                                                            min="0" max="100" step="0.01" name="new_taux_tva"
                                                    ...
                                                    <p class="text-xs text-gray-400 mt-1 italic">Pour calcul automatique
                                                    </p>
                                                </div>
                                                <div class="mt-3">
                                                    <label class="block text-xs text-gray-500 mb-1">Montant TVA
                                                        (FCFA)</label>
                                                    <input type="number" name="new_taxe_montant" id="new_taxe_montant"
                                                        value="{{ old('new_taxe_montant', 0) }}" min="0"
                                            ...
                                            <div class="bg-white/60 p-4 rounded-lg border border-purple-100">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        <input type="number" id="new_remise_pourcentage" value="0"
                                                ...
                                                <div class="mt-3">
                                                    <label class="block text-xs text-gray-500 mb-1">Montant remise
                                                        (FCFA)</label>
                                                    <input type="number" name="new_remise_montant"
                                                        id="new_remise_montant"
                                                        value="{{ old('new_remise_montant', 0) }}" min="0"
                                        ...
                                        <div class="grid grid-cols-2 gap-5">
                                            <div>
                                                <label class="block text-sm font-semibold text-gray-700 mb-2">Pénalités
                                                    (FCFA)</label>
                                                <input type="number" name="new_penalites" id="new_penalites"
                                                    value="{{ old('new_penalites', 0) }}" min="0"
                                                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-400">
                                            </div>
                                            <div>
                                                ...
                                                <input type="text" name="new_modalite" id="new_modalite"
                                                    ...
                                                    placeholder="30% commande, 70% livraison"
                                                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-400">
                                            </div>
                                        </div>
                                        <!-- Récap calculs -->
                                        <div
                                            class="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl p-5 text-white">
                                            <h4 class="font-semibold mb-4"><i
                                                    class="fas fa-calculator mr-2"></i>Récapitulatif</h4>
                                            <div class="space-y-2 text-sm">
                                                ...
                                                <div class="flex justify-between"><span class="text-purple-200">Remise
                                                        (<span id="calc_remise_pct">0</span>%)</span><span
                                                        id="calc_remise" class="text-green-300">- 0 FCFA</span></div>
                                                <hr class="border-purple-400 my-2">
                                                <div class="flex justify-between text-lg"><span
                                                        class="font-semibold">Total TTC</span><span id="calc_ttc"
                                                        class="font-bold text-yellow-300">0 FCFA</span></div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-b">
                            <h2 class="text-lg font-bold text-gray-800"><i
                                    class="fas fa-comment-alt text-gray-500 mr-2"></i>Informations complémentaires</h2>
                        </div>
                        <div class="p-6 space-y-5">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Observations</label>
                                <textarea name="observations" rows="3"
                                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-gray-400" placeholder="Notes...">{{ old('observations') }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Conditions
                                    particulières</label>
                                <textarea name="conditions_particulieres" rows="3"
                                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-gray-400"
                                    placeholder="Conditions spécifiques...">{{ old('conditions_particulieres') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        <div class="px-6 py-4 bg-gradient-to-r from-green-50 to-white border-b">
                            <h2 class="text-lg font-bold text-gray-800"><i
                                    class="fas fa-coins text-green-500 mr-2"></i>Paramètres financiers</h2>
                        </div>
                        <div class="p-6 space-y-5">
                            <div>
                                ...
                                <input type="number" name="montant_engage" id="montant_engage"
                                    value="{{ old('montant_engage', 0) }}" min="0"
                            ...
                            <div>
                                ...
                                <input type="number" name="taux_penalites" id="taux_penalites"
                                    value="{{ old('taux_penalites', 0) }}" min="0" max="100" step="0.01"
                                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-400">
                            </div>
                        </div>
                    </div>
                    <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl shadow-lg overflow-hidden">
                        <div class="px-6 py-4 border-b border-orange-200">
                            <h2 class="text-lg font-bold text-gray-800"><i
                                    class="fas fa-clipboard-check text-orange-500 mr-2"></i>Récapitulatif</h2>
                        </div>
                        <div class="p-6 space-y-3 text-sm">
                            <div class="flex justify-between"><span class="text-gray-600">Lot:</span><span id="recap_lot"
                                    class="font-medium truncate max-w-[150px]">-</span></div>
                            <div class="flex justify-between"><span class="text-gray-600">Prestataire:</span><span
                                    id="recap_prestataire" class="font-medium truncate max-w-[150px]">-</span></div>
                            <div class="flex justify-between"><span class="text-gray-600">Proforma:</span><span
                                    id="recap_proforma" class="font-medium">-</span></div>
                            <hr class="border-orange-200">
                            <div class="flex justify-between"><span class="text-gray-600">Durée:</span><span
                                    id="recap_duree" class="font-medium">-</span></div>
                            <div class="flex justify-between"><span class="text-gray-600">Montant:</span><span
                                    id="recap_montant" class="font-bold text-orange-700">-</span></div>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl shadow-lg p-6 space-y-3">
                        <button type="submit"
                            class="w-full px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-medium rounded-lg shadow-md flex items-center justify-center"><i
                                class="fas fa-check mr-2"></i>Enregistrer</button>
                        <a href="{{ route('attributions.index') }}"
                            class="w-full px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg flex items-center justify-center"><i
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const lotSelect = new TomSelect('#lot_id', {
                ...
                const prestataireSelect = new TomSelect('#prestataire_id', {
                    ...
                    render: {
                        option: function(d, e) {
                            const el = d.$option,
                                v = el?.dataset?.ville || '',
                                t = el?.dataset?.telephone || '';
                            return '<div class="py-2"><div class="font-medium">' + e(d.text.split(' - ')[
                                0]) + '</div>' + (v ?
                        ...
                        item: function(d, e) {
                            return '<div>' + e(d.text.split(' - ')[0]) + '</div>';
                        }
                    }
                });
                ...
                //         option: function(d, e) {
                //             const el = d.$option,
                //                 ttc = el?.dataset?.ttc || 0;
                //             return '<div class="py-2"><div class="font-medium">' + e(d.text.split(' - ')[
                //                 0]) + '</div><div class="text-sm text-purple-600 font-semibold">' + fmt(
                //                 ttc) + ' FCFA TTC</div></div>';
                //         }
                //     },
                //     onChange: function() {
                //         // updatePreview();
                ...
                // const modeSelect = document.getElementById('mode_select'),
                    modeCreate = document.getElementById('mode_create');
                const selectSection = document.getElementById('proforma_select_section'),
                    createSection = document.getElementById('proforma_create_section');
                const montantRetenu = document.getElementById('new_montant_retenu'),
                    tvaPct = document.getElementById('new_tva_pourcentage');
                const taxeMontant = document.getElementById('new_taxe_montant'),
                    remisePct = document.getElementById('new_remise_pourcentage');
                ...
                //     ['new_date_proforma', 'new_montant_retenu', 'new_date_redemarrage'].forEach(id => {
                //         const el = document.getElementById(id);
                //         if (el) el.required = !isSelect;
                //     });
                //     updateRecap();
                //     updateMontant();
                // }
                ...
                function calcProforma() {
                    const ht = parseFloat(montantRetenu.value) || 0,
                        tva = parseFloat(tvaPct.value) || 0,
                        rem = parseFloat(remisePct.value) || 0;
                    const taxe = Math.round(ht * tva / 100),
                        remise = Math.round(ht * rem / 100),
                        ttc = ht + taxe - remise;
                ...
                //     const sel = document.getElementById('proforma_id'),
                //         opt = sel.options[sel.selectedIndex],
                //         prev = document.getElementById('proforma_preview');
                //     if (opt && opt.value) {
                //         document.getElementById('preview_montant_ht').textContent = fmt(opt.dataset.montant || 0) +
                //             ' FCFA';
                //         document.getElementById('preview_taxe').textContent = fmt(opt.dataset.taxe || 0) + ' FCFA';
                //         document.getElementById('preview_remise').textContent = '- ' + fmt(opt.dataset.remise || 0) +
                //             ' FCFA';
                ...
                //         const sel = document.getElementById('proforma_id'),
                //             opt = sel.options[sel.selectedIndex];
                //         if (opt && opt.value && opt.dataset.ttc) document.getElementById('montant_engage').value =
                //             parseFloat(opt.dataset.ttc);
                //     }
                //     updateRecap();
                // }
                ...
                function updateRecap() {
                    ...
                    document.getElementById('recap_lot').textContent = lotOpt && lotOpt.value ? lotOpt.text.split(
                        ' - ')[0] : '-';
                    ...
                    //     const profOpt = document.querySelector('#proforma_id option:checked');
                    //     document.getElementById('recap_proforma').textContent = profOpt && profOpt.value ? profOpt.text
                    //         .split(' - ')[0] : '-';
                    // } else {
                        const num = document.getElementById('new_numero_proforma').value;
                        document.getElementById('recap_proforma').textContent = num ? num + ' (nouvelle)' : 'Nouvelle';
                    // }
                    updateDuree();
                ...
                function updateDuree() {
                    const d = new Date(document.getElementById('date_debut_prevue').value),
                        f = new Date(document.getElementById('date_fin_prevue').value);
                    if (document.getElementById('date_debut_prevue').value && document.getElementById('date_fin_prevue')
                        .value && f > d) {
                        const diff = Math.ceil(Math.abs(f - d) / (1000 * 60 * 60 * 24)),
                            txt = diff + ' jour' + (diff > 1 ? 's' : '');
                        document.getElementById('dureeCalculee').textContent = txt;
                        document.getElementById('recap_duree').textContent = txt;
                    } else {
                ...
                lotSelect.on('change', updateRecap);
                prestataireSelect.on('change', updateRecap);
