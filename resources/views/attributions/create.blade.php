    ...
    <div class="bg-gradient-to-r from-gray-50 to-white border-b border-gray-200 shadow-sm">
        <div class="px-3 sm:px-4 lg:px-6 py-4">
            <div class="flex items-center space-x-4">
                <a @can('attributions_lots.read') href="{{ route('attributions.index') }}" @endcan
                    class="p-2 hover:bg-gray-100 rounded-lg"><i class="fas fa-arrow-left text-gray-600"></i></a>
                <div>
        ...
        @can('attributions_lots.assign')
            <form action="{{ route('attributions.store') }}" method="POST" id="attributionForm">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg">
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Prestataire <span
                                            class="text-red-500">*</span></label>
                                ...
                                <div id="proforma_create_section">
                                    <div
                                        ...
                                        <div class="p-5 space-y-5">
                                            ...
                                            <div>
                                                <label class="block text-sm font-semibold text-gray-700 mb-2">Budget Global HT
                    ...
                    @canany(['attributions_lots.read', 'attributions_lots.assign'])
                        <div class="space-y-6">
                            <div class="mt-6 flex flex-col sm:flex-row gap-3 sm:justify-end">
                                @can('attributions_lots.read')
                                    <a href="{{ route('attributions.index') }}"
                                        class="w-full sm:w-auto px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg flex items-center justify-center order-2 sm:order-1">
                                ...
                                @can('attributions_lots.assign')
                                    <button type="submit"
                                        class="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-medium rounded-lg shadow-md flex items-center justify-center order-1 sm:order-2">
