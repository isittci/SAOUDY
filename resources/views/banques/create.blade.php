                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-5">
                            <div>
                                ...
                                <input type="text" name="nom_banque" id="nom_banque" required value="{{ old('nom_banque') }}" placeholder="Ex: Bank of Africa, Ecobank..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent @error('nom_banque') border-red-500 @enderror">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" name="code_banque" id="code_banque" value="{{ old('code_banque') }}" placeholder="Ex: CI008" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent @error('code_banque') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="titulaire_compte_banque" id="titulaire_compte_banque" value="{{ old('titulaire_compte_banque') }}" placeholder="Nom du titulaire" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent @error('titulaire_compte_banque') border-red-500 @enderror">
                        ...
                        <div class="p-6 space-y-5">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" name="numero_compte_banque" id="numero_compte_banque" value="{{ old('numero_compte_banque') }}" placeholder="Ex: 01041308549" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent font-mono @error('numero_compte_banque') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="code_guichet_banque" id="code_guichet_banque" value="{{ old('code_guichet_banque') }}" placeholder="Ex: 01001" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent font-mono @error('code_guichet_banque') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="text" name="cle_rib_banque" id="cle_rib_banque" value="{{ old('cle_rib_banque') }}" placeholder="Ex: 85" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent font-mono @error('cle_rib_banque') border-red-500 @enderror">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-5">
                            <div>
                                ...
                                <input type="text" name="iban_banque" id="iban_banque" value="{{ old('iban_banque') }}" placeholder="Ex: CI93CI0080104130854900185" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent font-mono uppercase @error('iban_banque') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="text" name="swift_bic_banque" id="swift_bic_banque" value="{{ old('swift_bic_banque') }}" placeholder="Ex: SGBFCIAB" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent font-mono uppercase @error('swift_bic_banque') border-red-500 @enderror">
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            <label class="flex items-center cursor-pointer">
                                <div class="relative">
                                    <input type="checkbox" name="actif_banque" value="1" {{ old('actif_banque', true) ? 'checked' : '' }} class="sr-only peer">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="p-3 bg-blue-50 rounded-lg">
                                <p class="text-sm text-blue-700"><i class="fas fa-info-circle mr-1"></i>Le <strong>RIB</strong> est composé du code banque, code guichet, numéro de compte et clé.</p>
                            </div>
                            <div class="p-3 bg-green-50 rounded-lg">
                                <p class="text-sm text-green-700"><i class="fas fa-globe mr-1"></i>L'<strong>IBAN</strong> et le <strong>SWIFT</strong> sont nécessaires pour les virements internationaux.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        <div class="p-6 space-y-3">
                            ...
                            <button type="button" onclick="window.location.href='{{ route('banques.index', $prestataire->id_prestataire) }}'" class="w-full px-6 py-3 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2 font-medium">
