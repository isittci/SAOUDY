...
@section('content')
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">{{ $appelOffre->numero_appel_offre }} - {{ $appelOffre->libelle_critere_appel_offre }}</p>
                    </div>
                </div>
    ...
    <main class="flex-1 overflow-y-auto bg-gradient-to-br from-gray-50 to-gray-100 p-3 sm:p-4 lg:p-6">
        ...
        <!-- Formulaire -->
        <form method="POST" action="{{ route('caracteristiques-appels-offres.store', $appelOffre->id_appel_offre) }}" class="max-w-5xl mx-auto">
            @csrf
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number"
                                ...
                                step="0.01"
                                min="0"
                                value="{{ old('penalites_retard_journalier_caracteristique_appel_offre') }}"
                        ...
                        <div>
                            ...
                            <input type="number"
                                ...
                                step="0.01"
                                min="0"
                                value="{{ old('montant_garantie_caracteristique_appel_offre') }}"
                        ...
                        <div>
                            ...
                            <input type="number"
                                ...
                                step="0.01"
                                min="0"
                                value="{{ old('delai_garantie_jours_caracteristique_appel_offre') }}"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Ex: 30% avance, 40% mi-parcours, 30% livraison...">{{ old('conditions_paiement_caracteristique_appel_offre') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Exigences particulières pour l'exécution du marché...">{{ old('modalites_execution_caracteristique_appel_offre') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Ex: Attestation fiscale, Certificat d'assurance, Caution bancaire...">{{ old('documents_requis_caracteristique_appel_offre') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Informations complémentaires...">{{ old('autres_informations_caracteristique_appel_offre') }}</textarea>
