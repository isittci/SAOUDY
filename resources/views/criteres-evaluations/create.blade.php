...
@section('breadcrumb')
    ...
    <i class="fas fa-chevron-right text-white/50 text-xs mx-2"></i>
    <a @can('criteres_evaluations.read') href="{{ route('criteres-evaluations.index', [$lot->appelOffre->id_appel_offre, $lot->id_lot]) }}" @endcan class="text-white/80 hover:text-white transition-colors" title="Liste des critères d'évaluation - {{ $lot->libelle }}">Critères d'évaluation</a>
    <i class="fas fa-chevron-right text-white/50 text-xs mx-2"></i>
