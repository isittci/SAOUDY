                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap gap-3 text-sm">
                                ...
                                @endif
                                @if ($alertes['appels_offres_expirant'] > 0)
                                    <a @can('appels_offres.read') href="{{ route('appels-offres.index') }}" @endcan
                                        class="inline-flex items-center px-3 py-1 bg-red-100 text-red-800 rounded-full hover:bg-red-200 transition-colors">
                                        <i class="fas fa-exclamation-triangle mr-1"></i>
                                        {{ $alertes['appels_offres_expirant'] }} appel(s) d'offres expirant bientôt
                                    </a>
                                @endif
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Date limite</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($appelsOffresRecents as $ao)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <p class="text-sm text-gray-800 truncate max-w-xs" title="{{ $ao->objet_critere_appel_offre }}">
                                            {{ \Str::limit($ao->objet_critere_appel_offre, 50) }}
                                        </p>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <span class="font-semibold text-gray-800">{{ number_format($ao->montant_global_appel_offre, 0, ',', ' ') }}</span>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if ($ao->date_limite_depot_critere_appel_offre)
                                            <span
                                                class="text-sm {{ $ao->date_limite_depot_critere_appel_offre < now() ? 'text-red-600' : 'text-gray-800' }}">
                                                {{ $ao->date_limite_depot_critere_appel_offre->format('d/m/Y') }}
                                            </span>
                                        @else
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($lotsEnCours as $lot)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-right">
                                            @if ($lot['est_attribue'])
                                                <div class="text-sm font-semibold text-gray-900">
                                                    {{ number_format($lot['montant_lot'], 0, ',', ' ') }}
                                                </div>
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-right">
                                            @if ($lot['est_attribue'])
                                                <div class="text-sm font-medium text-green-600">
                                                    {{ number_format($lot['montant_paye'], 0, ',', ' ') }}
                                                </div>
                                                <div class="text-xs text-gray-500">FCFA</div>
                                            @else
                                                <span class="text-sm text-gray-400">-</span>
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-right">
                                            @if ($lot['est_attribue'])
                                                <div class="text-sm font-medium {{ $lot['reste_a_payer'] > 0 ? 'text-orange-600' : 'text-gray-400' }}">
                                                    {{ number_format($lot['reste_a_payer'], 0, ',', ' ') }}
                                                </div>
                                                <div class="text-xs text-gray-500">FCFA</div>
                                            @else
                                                <span class="text-sm text-gray-400">-</span>
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-center">
                                            @if ($lot['est_attribue'] && $lot['delai_restant'])
                                                @if ($lot['delai_jours'] !== null && $lot['delai_jours'] < 0)
                                                    <span
                                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                                        <i
                                                            class="fas fa-exclamation-triangle mr-1"></i>{{ $lot['delai_restant'] }}
                                                    </span>
                                                @elseif($lot['delai_jours'] !== null && $lot['delai_jours'] <= 7)
                                                    <span
                                                ...
                                                @else
                                                    <span
                                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                        <i class="fas fa-check mr-1"></i>{{ $lot['delai_restant'] }}
                                                    </span>
                                                @endif
                                            @else
                                                <span class="text-sm text-gray-400">-</span>
