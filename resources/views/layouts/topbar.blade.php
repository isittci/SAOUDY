...
<header class="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 shadow-xl sticky top-0 z-30">
    <div class="flex items-center justify-between px-3 sm:px-4 lg:px-6 py-3">
        ...
        <div class="flex-1 max-w-3xl">
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <i class="fas fa-search text-gray-400 text-sm group-focus-within:text-orange-500 transition-colors"></i>
                </div>
                <input type="text"
                       placeholder="Rechercher un appel d'offres, prestataire..."
        ...
        <div class="flex items-center space-x-2 sm:space-x-3 lg:space-x-4 ml-2 sm:ml-4">
            <!-- Notifications -->
            <div class="relative">
                <button class="text-white hover:bg-orange-600/80 p-2.5 rounded-xl transition-all duration-200 relative group active:scale-95 shadow-md">
            ...
            <div class="relative">
                <button onclick="toggleUserMenu()"
                    ...
                    <div class="relative">
                        <div class="w-9 h-9 lg:w-10 lg:h-10 bg-gradient-to-br from-white to-gray-100 rounded-full flex items-center justify-center flex-shrink-0 shadow-md ring-2 ring-white/50 group-hover:ring-white transition-all">
                            <i class="fas fa-user text-orange-500 text-sm lg:text-base"></i>
                        </div>
                        <!-- Status indicator -->
                        <span class="absolute bottom-0 right-0 block h-3 w-3 rounded-full bg-green-400 ring-2 ring-white shadow-sm"></span>
                    </div>
                    <div class="hidden sm:flex flex-col items-start">
                        <span class="font-semibold text-white text-sm leading-tight">{{auth()->user()->nom_complet}}</span>
                        <span class="text-xs text-orange-100">{{auth()->user()->role->name}}</span>
                    </div>
                    <i id="userMenuIcon" class="hidden sm:block fas fa-chevron-down text-white text-xs transition-transform duration-300 group-hover:text-orange-100"></i>
                </button>
                ...
                <div id="userMenu"
                    ...
                    <div class="px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-orange-50 to-white">
                        <div class="flex items-center space-x-3">
                            <div class="w-12 h-12 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center shadow-md">
                                <i class="fas fa-user text-white text-lg"></i>
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-800 text-sm truncate">{{auth()->user()->nom_complet}}</p>
                    ...
                    <!-- Menu Items -->
                    <div class="py-2">
                        <a href="#" class="flex items-center space-x-3 px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-orange-50 hover:to-transparent transition-all duration-200 group">
