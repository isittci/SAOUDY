...
@section('breadcrumb')
    <a href="{{ route('lots.index') }}" class="text-white/80 hover:text-white transition-colors">Lots</a>
    <i class="fas fa-chevron-right text-white/50 text-xs mx-2"></i>
    <a href="{{ route('lots.show', $lot->id_lot) }}" class="text-white/80 hover:text-white transition-colors">{{ $lot->numero }}</a>
    <i class="fas fa-chevron-right text-white/50 text-xs mx-2"></i>
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-blue-700 text-sm">
                        La modification de ce lot créera une nouvelle version. L'ancienne version sera conservée dans l'historique.
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-600">
                                        ...
                                        Montant global: <strong>{{ number_format($lot->appelOffre->montant_global_appel_offre, 0, ',', ' ') }} FCFA</strong>
                                    </p>
                                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea
                                name="description_critere"
                                id="description_critere"
                                rows="4"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number"
                                    ...
                                    max="100"
                                    step="0.01"
                                    value="{{ old('taux_penalites', $lot->taux_penalites) }}"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent @error('taux_penalites') border-red-500 @enderror"
                                    placeholder="Ex: 1.5">
    ...
    @push('scripts')
        <script>
            ...
            document.querySelector('form').addEventListener('submit', function(e) {
                ...
                if (!confirm('Êtes-vous sûr de vouloir enregistrer ces modifications ? Une nouvelle version du lot sera créée.')) {
                    e.preventDefault();
                    return false;
                }
            });
