...
Route::middleware(['auth:sanctum'])->prefix('appels-offres/{appel_offre}/caracteristiques')->name('api.caracteristiques-appels-offres.')->group(function () {
...
Route::middleware(['auth:sanctum'])->prefix('lots')->name('api.lots.')->group(function () {
...
Route::middleware(['auth:sanctum'])->prefix('appels-offres/{appel_offre}/lots')->name('api.lots-appels-offres.')->group(function () {
