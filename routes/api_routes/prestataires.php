...
Route::middleware(['auth:sanctum'])->prefix('prestataires')->name('api.prestataires.')->group(function () {
...
Route::prefix('prestataires/{prestataire}/capacites-techniques')
    ->name('api.prestataires.capacites-techniques.')
...
Route::prefix('prestataires/{prestataire}/situations-financieres')
    ->name('api.prestataires.situations-financieres.')
    ->middleware(['auth:sanctum'])
    ->group(function () {
